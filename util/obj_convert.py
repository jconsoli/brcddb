...
Extracts a list of objects from one object type to another

Getting a list of port objects from a switch object is easy because the switch object has a built-in method
r_port_objects() but extrapolation is not always that straight forward. For example, you may want a list of all port
objects associated with a zone object. This module contains the method obj_extract() which returns a list of any
requested object from any object.
