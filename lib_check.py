...
_imports = (
    ...
    {'l': 'brcdapi.brcdapi_rest', 'd': 'FOS RESTConf API driver.', 'r': '3.1.0'},
    ...
    {'l': 'brcdapi.gen_util', 'd': 'Required by most scripts.', 'r': '1.0.7'},
    ...
    {'l': 'brcddb.brcddb_fabric', 'd': 'Required for most brcddb libraries', 'r': '3.2.0'},
    ...
    {'l': 'brcddb.brcddb_project', 'd': 'Required for most brcddb libraries', 'r': '3.1.3'},
    ...
    {'l': 'brcddb.classes.chassis', 'd': 'Required for all brcddb libraries', 'r': '3.0.7'},
    {'l': 'brcddb.classes.fabric', 'd': 'Required for all brcddb libraries', 'r': '3.1.0'},
    {'l': 'brcddb.classes.iocp', 'd': 'Required for all brcddb libraries', 'r': '3.0.7'},
    {'l': 'brcddb.classes.login', 'd': 'Required for all brcddb libraries', 'r': '3.0.6'},
    {'l': 'brcddb.classes.port', 'd': 'Required for all brcddb libraries', 'r': '3.0.9'},
    {'l': 'brcddb.classes.project', 'd': 'Required for all brcddb libraries', 'r': '3.0.8'},
    {'l': 'brcddb.classes.switch', 'd': 'Required for all brcddb libraries', 'r': '3.0.9'},
    {'l': 'brcddb.classes.util', 'd': 'Required for all brcddb libraries', 'r': '3.0.9'},
    {'l': 'brcddb.classes.zone', 'd': 'Required for all brcddb libraries', 'r': '3.0.9'},
    ...
    {'l': 'brcddb.util.parse_cli', 'd': 'Required for most brcddb libraries', 'r': '1.0.6'},
    ...
    {'l': 'brcddb.report.utils', 'd': 'Required for generating Excel reports', 'r': '3.1.5'},
    {'l': 'brcddb.report.zone', 'd': 'Required for generating Excel reports', 'r': '3.1.5'},
