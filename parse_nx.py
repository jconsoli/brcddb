# Copyright 2023 Broadcom Communications, Inc.  All rights reserved.
#
...
Version Control::
    ...
    +===========+===============+===================================================================================+
    | 1.0.0     | 01 Jan 2023   | Initial launch                                                                    |
    +-----------+---------------+-----------------------------------------------------------------------------------+
"""

__author__ = 'Jack Consoli'
__copyright__ = 'Copyright 2023 Broadcom Communications, Inc.'
